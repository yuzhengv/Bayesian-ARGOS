...
if (sr_method == "lasso") {
    save(
        ...
        metadata,
        file = sprintf(
            "./Experiments/argos-lasso/forced-duffing/results/forced-duffing_%s_e%s_e%s_bo%s_se%s_%s_snr%s.RData",
            state_var_deriv,
            start,
            end,
            num_samples,
    ...
    save(
        ...
        metadata,
        file = sprintf(
            "./Experiments/argos-alasso/forced-duffing/results/forced-duffing_%s_e%s_e%s_bo%s_se%s_%s_%s_snr%s.RData",
            state_var_deriv,
            start,
            end,
            num_samples,
