...
# z <- runif(1, min = 0, max = 1) #60%

# x <- runif(1, min = -0.5, max = 0.5)
# y <- runif(1, min = -0.5, max = 0.5)
# z <- runif(1, min = 0, max = 0.5) #40%
...
save(
    ...
    metadata,
    file = sprintf(
        "./Experiments/bayesian-alasso-ro/aizawa/results/aizawa_%s_e%s_e%s_se%s_snr%s.RData",
        state_var_deriv,
        start,
        end,
        seed,
